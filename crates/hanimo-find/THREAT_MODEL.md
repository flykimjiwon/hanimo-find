...
- Governance is documented and honest about its limits: a solo maintainer, a
  ...
  [MAINTAINERS.md](https://github.com/flykimjiwon/hanimo-find/blob/main/MAINTAINERS.md),
  [PROVENANCE.md](PROVENANCE.md), and
  [RELEASE_GATE.md](https://github.com/flykimjiwon/hanimo-find/blob/main/RELEASE_GATE.md).
